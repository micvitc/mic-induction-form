...
import { Rocket, Calendar, Clock, MapPin, Users, Club } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="max-w-5xl mx-auto text-center py-16 px-6 bg-white/10 backdrop-blur-md rounded-lg border border-white/20 mb-10">
          <h1 className="text-3xl md:text-4xl font-bold text-white leading-tight mb-8">
            Join VIT's Most Elite Student Clubs – Home to the top 1% of VITians who lead innovation, not just participate in it.
          </h1>
          
          <p className="text-lg text-white mb-6 text-left flex items-start">
            <span className="text-yellow-400 mr-3 mt-1">⚡</span>
            <span><span className="font-bold">Work on High-Impact, Real-World Projects</span> – Go beyond classroom theory with initiatives that drive visible change and build your legacy.</span>
          </p>
          
          <p className="text-lg text-white mb-6 text-left flex items-start">
            <span className="text-blue-400 mr-3 mt-1">💼</span>
            <span><span className="font-bold">Strengthen Your LinkedIn with Credible Experience</span> – Gain recognition through roles and achievements that recruiters and companies value.</span>
          </p>
          
          <p className="text-lg text-white mb-6 text-left flex items-start">
            <span className="text-green-400 mr-3 mt-1">🤝</span>
            <span><span className="font-bold">Network with VIT's Most Influential Students</span> – Collaborate with changemakers who are shaping VIT's future across tech, business, design, and beyond.</span>
          </p>
          
          <p className="text-lg text-white mb-6 text-left flex items-start">
            <span className="text-purple-400 mr-3 mt-1">👑</span>
            <span><span className="font-bold">Develop Practical Leadership & Execution Skills</span> – Take up core roles, lead teams, manage events, and own responsibilities from day one.</span>
          </p>
          
          <p className="text-lg text-white mb-6 text-left flex items-start">
            <span className="text-red-400 mr-3 mt-1">🌟</span>
            <span><span className="font-bold">Get Exclusive Exposure to National-Level Events & Collaborations</span> – Be the face of VIT at major hackathons, conferences, and inter-collegiate showcases.</span>
          </p>
          
          <p className="text-lg text-white text-left flex items-start">
            <span className="text-cyan-400 mr-3 mt-1">🚀</span>
            <span><span className="font-bold">Be Where the Future Is Built</span> – While others settle for average, you'll be part of the movement that defines what excellence at VIT truly looks like.</span>
          </p>
        </div>
